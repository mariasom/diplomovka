...
Na obr. \ref{fig:uidata2}a sú zobrazené dáta s makrofágom, na ktoré bol aplikovaný SUBSURF, za počiatočnú podmienku bola použitá dištančná funkcia.

%\begin{figure}[h!]
% \begin{center} 
% \includegraphics[scale=0.50]{pics/subsurf.jpg}
%\caption{Grafické rozhranie programu zobrazujúce 3D dáta spolu s osami x,y,z.}
%\end{center} 
%\label{fig:uisubsurf}
%\end{figure}
...
Na obr. \ref{fig:uidata2}b sú vidieť pôvodné dáta, na ktorých je zobrazená výsledná izočiara.
...
%\begin{figure}[H]
% \begin{center} 
% \includegraphics[scale=0.60]{pics/uidata.jpg}
%\caption{Detail docku \textit{Data}.}
%\end{center} 
%\label{fig:uidata}
 
% \includegraphics[scale=0.60]{pics/uithr.jpg}
%\caption{Detail docku \textit{Thresholding}.}
%\end{center} 
%\label{fig:uidata}
%\end{figure}
