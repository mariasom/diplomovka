...
\begin{figure}[h!]%
    \centering
    \subfloat[Detail docku \texttt{Data}.]{{\includegraphics[width=7cm]{pics/uidata.jpg} }}%
    \qquad
    \subfloat[Detail docku \texttt{Thresholding}.]{{\includegraphics[width=6cm]{pics/uithr.jpg} }}%
