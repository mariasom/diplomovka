...
\begin{figure}[H]%
    \centering
    \subfloat[Grafické rozhranie programu zobrazujúce znamienkovú funkciu vzdialenosti spolu s osami x,y,z.]{{\includegraphics[scale=0.3]{pics/sdf.jpg} }}%
    \qquad
    \subfloat[Grafické rozhranie programu zobrazujúce prahovaciu funkciu.]{{\includegraphics[scale=0.3]{pics/tf.jpg} }}%
    \caption{}%
    \label{fig:pp}%
\end{figure}
...
\begin{figure}[H]%
    \centering
    \subfloat[Grafické rozhranie a výsledok segmentačnej funkcie pri použití znamienkovej funkcie vzdialenosti pre počiatočnú podmienku.]{{\includegraphics[scale=0.3]{pics/res_sdf.jpg} }}%
    \qquad
    \subfloat[Grafické rozhranie a výsledok segmentačnej funkcie pri použití prahovacej funkcie pre počiatočnú podmienku.]{{\includegraphics[scale=0.3]{pics/res_tf.jpg} }}%
    \caption{}%
...
\begin{figure}[H]%
    \centering
    \subfloat[Grafické rozhranie, výsledok segmentačnej funkcie pri použití znamienkovej funkcie vzdialenosti pre počiatočnú podmienku a izočiara na hodnote $z = -1.5$ .]{{\includegraphics[scale=0.3]{pics/res_iso_3sdf.jpg} }}%
    \qquad
    \subfloat[Grafické rozhranie, výsledok segmentačnej funkcie pri použití prahovacej funkcie pre počiatočnú podmienku a izočiara na hodnote $z = -1.5$.]{{\includegraphics[scale=0.3]{pics/res_iso_3tf.jpg} }}%
    \caption{}%
    \label{fig:res_iso}%
\end{figure}
...
\begin{figure}[H]%
    \centering
    \subfloat[Grafické rozhranie, výsledná izočiara na pôvodných.]{{\includegraphics[scale=0.3]{pics/res_iso_sdf.jpg} }}%
    \qquad
    \subfloat[Grafické rozhranie a výsledok segmentačnej funkcie pri použití prahovacej funkcie pre počiatočnú podmienku.]{{\includegraphics[scale=0.3]{pics/res_iso_tf.jpg} }}%
    \caption{}%
...
\begin{figure}[H]  
 \subfloat[cropT2]   
   {\includegraphics[scale=0.21]{pics/cropT2_otsu_tf.png}}
    ...
    \hspace{5px}
     \subfloat[cropT27] 
    {\includegraphics[scale=0.21]{pics/cropT27_otsu_tf.png}}
    \hspace{5px}
     \subfloat[cropT45] 
    {\includegraphics[scale=0.21]{pics/cropT45_otsu_tf.png}}
    \caption{Výsledok SUBSURFu za použitia Otsuho prahovacej metódy.}
    \label{fig:otsu_res}
\end{figure}
...
\begin{figure}[H]  
\subfloat[cropT2]   
   {\includegraphics[scale=0.2]{pics/cropT2_kapur_sdf.png}}
    \hspace{5px}
    \subfloat[cropT7] 
   {\includegraphics[scale=0.2]{pics/cropT7_kapur_sdf.png}}
    \hspace{5px}
     \subfloat[cropT27] 
    {\includegraphics[scale=0.2]{pics/cropT27_kapur_sdf.png}}
    \hspace{5px}
    \subfloat[cropT45] 
   {\includegraphics[scale=0.2]{pics/cropT45_kapur_sdf.png}}
...
\begin{figure}[H]  
\subfloat[cropT2]   
   {\includegraphics[scale=0.2]{pics/cropT2_kapur_tf.png}}
    \hspace{5px}
    \subfloat[cropT7] 
   {\includegraphics[scale=0.2]{pics/cropT7_kapur_tf.png}}
    \hspace{5px}
     \subfloat[cropT27] 
    {\includegraphics[scale=0.2]{pics/cropT27_kapur_tf.png}}
    \hspace{5px}
    \subfloat[cropT45] 
   {\includegraphics[scale=0.2]{pics/cropT45_kapur_tf.png}}
    \caption{Výsledok SUBSURFu pre prah nájdený pomocou maximálnej entropie.}
    \label{fig:kapur_res}
\end{figure}
