...
public:
	...
	QVector<double> subSurf(QVector<double> data, QVector<double> tData, int steps, double sigma, double tau, double k, bool gradType); //sigma - size of lin. time steps, tau - nonlinear time steps, k - sensitivity coeficient
	...
	void grad2(QVector<double> data, double k, double sigma);
	void grad3(QVector<double> data, double k, double sigma);
};